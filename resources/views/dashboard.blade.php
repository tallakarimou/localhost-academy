                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="{{assert('assets')}}/img/flags/US.png">
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="{{assert('assets')}}/img/flags/DE.png">
                                                                </div>
                                                            </td>
                                                            <td>Germany</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="{{assert('assets')}}/img/flags/AU.png">
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="{{assert('assets')}}/img/flags/GB.png">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="{{assert('assets')}}/img/flags/RO.png">
                                                                </div>
                                                            </td>
                                                            <td>Romania</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="{{assert('assets')}}/img/flags/BR.png">
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                                                            <td class="text-right">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="{{assert('assets')}}/img/card-2.jpg">
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="{{assert('assets')}}/img/card-3.jpg">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="card-actions text-center">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="{{assert('assets')}}/img/card-1.jpg">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="card-actions text-center">
