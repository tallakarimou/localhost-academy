...
<head>
    ...
    <!-- CSS Files -->
    <link href="<?php echo e(asset('assets')); ?>/css/material-dashboard.min.css?v=2.1.0" rel="stylesheet" />
...
<body class="">
    ...
    <!-- fixed plugin le plugin-->
    <?php echo $__env->make('layouts.partials.plugin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/js/material-dashboard.min.js?v=2.1.0" type="text/javascript"></script>
...
</html><?php /**PATH C:\xampp\htdocs\localhost_academy\resources\views/layouts/app.blade.php ENDPATH**/ ?>